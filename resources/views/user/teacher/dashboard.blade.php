                        ...
                        <div class="panel-item p-4 d-flex align-items-start">
                            ...
                            <div class="card-text">
                                <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">First Name : <span
                                        style="font-weight: normal;">{{Auth::guard('teacher')->user()->fname}}</span><br><span
                                        style="font-weight: normal;">&nbsp;</span><br>Last Name : <span
                                        style="font-weight: normal;">{{Auth::guard('teacher')->user()->lname}}</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-item p-4 d-flex align-items-start">
                            ...
                            <div class="card-text">
                                <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">ID : <span
                                        style="font-weight: normal;">{{Auth::guard('teacher')->user()->teacher_id}}</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-item p-4 d-flex align-items-start">
                            ...
                            <div class="card-text">
                                <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">Email :
                                    <span style="font-weight: normal;">{{Auth::guard('teacher')->user()->email}}</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-item p-4 d-flex align-items-start">
                            ...
                            <div class="card-texts">
                                <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">Contact:<span
                                        style="font-weight: normal;">{{Auth::guard('teacher')->user()->contact}}</span>
                                </h4>
                            </div>
                        </div>
                    </div>
