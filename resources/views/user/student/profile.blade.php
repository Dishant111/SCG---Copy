                        ...
                        <div class="panel-item p-4 d-flex align-items-start">
                            ...
                            <div class="card-text">
                                <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">First Name : <span
                                        style="font-weight: normal;">{{$data['student']->fname}}</span><br><span
                                        style="font-weight: normal;">&nbsp;</span><br>Last Name : <span
                                        style="font-weight: normal;">{{$data['student']->lname}}</span></h4>
                            </div>
                        </div>
                    </div>
                    <div class="card px-3 align-left col-12">
                        <div class="panel-item p-4 d-flex align-items-start">
                            ...
                            <div class="card-text">
                                <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">ID : <span
                                        style="font-weight: normal;">{{$data['student']->student_id}}</span></h4>
                            </div>
                        </div>
                    </div>
                    <div class="card px-3 align-left col-12">
                        <div class="panel-item p-4 d-flex align-items-start">
                            ...
                            <div class="card-text">
                                <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">Parent's First name :
                                    <span style="font-weight: normal;">{{$data['parent']->fname}}</span><br>
                                </h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-item p-4 d-flex align-items-start">
                            ...
                            <div class="card-texts">
                                <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">Email : <span
                                        style="font-weight: normal;">{{$data['student']->email}}</span><br>
                                    <br>Contact : <span
                                        style="font-weight: normal;">{{$data['student']->contact}}</span>
                                </h4>
                            </div>
                        </div>
                    </div>
